...
- **작문 연습 (AI 채점)**: **문장 영작**(기초·중급·고급·실전 4단계) · **자유 작문** · **IT 비즈니스 실무 작문**을 티타가 채점해 줘요 — 모범답안·잘한 점·교정 팁·점수(0~100)를 한 번에. 합격(60점↑) 시 XP 적립. 조합형 생성기로 **문장 영작 약 19,800가지 · 자유 작문 약 15,600가지 · IT 실무 약 5,900가지** 경우의 수를 제공해 매번 새로운 문제가 나와요
  - **IT 비즈니스 실무 작문**: 이메일·Slack 메시지·버그 리포트·PR 설명·릴리스 노트·회의록·보고 등 현업 시나리오. 티타가 전문성·톤·형식까지 함께 봐 줘요
