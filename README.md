...
- **단어 학습 (일본어 2,000 + 영어 1500)** — Day당 20개 단위, 간격 반복(SR) 스케줄
  ...
  - **N1 tail 800** (7번): 저빈도 구간, 4회분(Day 1~10 + 11~20 + 21~30 + 31~40)으로 확장. Day 1~5·11~15·21~25·31~35는 **和語 동사·형용사·명사**(`捗る`·`滞る`·`拙い`·`憚る`·`揺さぶる`·`肩代わりする`·`阻止する`·`凌ぐ`), Day 6~10·16~20·26~30·36~40은 **특수 요미**(`為替=かわせ`·`所以=ゆえん`·`太刀=たち`·`従兄弟=いとこ`·`海女=あま`)와 오독 유발 짝(`工夫` くふう/こうふ, `決裁`/`決済`, `遍在`/`偏在`, `大勢` おおぜい/たいせい, `叔父`/`伯父` 둘 다 おじ, `湧く`/`沸く` 둘 다 わく, `枯れる`/`涸れる` 둘 다 かれる, `抑える`/`押さえる` 둘 다 おさえる). 뜻 칸이 쉬워 보여도 **학습 목표는 요미**입니다
