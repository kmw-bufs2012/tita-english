...
- **단어 학습 (일본어 2,200 + 영어 1500)** — Day당 20개 단위, 간격 반복(SR) 스케줄
  ...
  - **QA·LQA 실무 용어 200** (8번, JLPT와 무관): 시험이 아니라 **면접·첫 출근 첫 주**를 위한 덱. 「文字あふれ」·「表記揺れ」·「禁則処理」·「起票」처럼 N1을 만점 받아도 안 나오지만 지적 시트·버그 티켓에서는 매일 쓰는 말들. QA 공통(테스트·버그 리포트·중대도) 3일 + LQA 고유(誤訳·文字化け·文字あふれ·禁則処理·表記揺れ) 6일 + 語調·경어·진행 관리 1일
