...
- **단어 학습 (일본어 1,800 + 영어 1500)** — Day당 20개 단위, 간격 반복(SR) 스케줄
  ...
  - **N1 tail 600** (7번): 저빈도 구간, 3회분(Day 1~10 + 11~20 + 21~30)으로 확장. Day 1~5·11~15·21~25는 **和語 동사·형용사·명사**(`捗る`·`滞る`·`拙い`·`覚束ない`·`憚る`·`揺さぶる`·`肩代わりする`·`一任する`), Day 6~10·16~20·26~30은 **특수 요미**(`為替=かわせ`·`所以=ゆえん`·`五月雨=さみだれ`·`太刀=たち`·`従兄弟=いとこ`)와 오독 유발 짝(`工夫` くふう/こうふ, `決裁`/`決済`, `遍在`/`偏在`, `大勢` おおぜい/たいせい, `叔父`/`伯父` 둘 다 おじ, `阻害`/`疎外` 둘 다 そがい). 뜻 칸이 쉬워 보여도 **학습 목표는 요미**입니다
