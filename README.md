...
- **영어 문법 — 90일 완성 과정 + 대학·대학원 심화**
  - **90일 완성 문법 과정 (Day 1~90)**: 하루 10~15분씩 Day를 하나씩 해금하며 진행하는 3단계 커리큘럼
    - **1단계 중학 문법 (Day 1~30, 45유닛)**: be동사·시제·조동사·수동태·부정사·동명사·분사·비교·관계대명사·접속사·문장 5형식. 유닛마다 개념 + 예문 5개 + 확인 퀴즈 5문제
    - **2단계 고등 문법 (Day 31~60, 35유닛)**: 완료시제 심화·가정법·분사구문·관계부사/복합관계사·도치·강조·병렬·명사절/부사절·수일치. 유닛마다 개념 + 예문 7개 + 퀴즈 7문제 + ‘중학 문법과의 연결점’ 복습
    - **3단계 수능 어법 (Day 61~90, 25유형 + 모의고사)**: 수능 최다 출제 어법 유형 25개(수일치·태·분사·관계사·병렬·대명사 일치 등)를 유사 창작 문제로. Day 85~90은 하루 20문제 **종합 모의 테스트 6회**
    - **단계 잠금·해금**: 이전 Day를 완료하면 다음 Day가 열려요. ‘건너뛰기 테스트’(10문제 중 7문제↑)로 단계를 통째로 열 수도 있어요
    - **XP 연동**: Day를 완료할 때마다 기존 XP·레벨 시스템에 경험치가 쌓여요
  - **대학·대학원 심화**: 학술 글 읽기·에세이 쓰기(대학 22단원), 명사화·헤징·분열문·학술 시제 등 논문 영어 문법(대학원 20단원)을 자유 열람으로 학습
  - **ADHD 친화 설계**: 유닛마다 ‘딱 이거 하나만!’ 한 줄 핵심 + 티타식 ‘기억 꿀팁(연상)’을 맨 위에 먼저 보여줘 한눈에 이해
...
Next.js 14 · React 18 · TypeScript(문법 데이터) · Tailwind CSS · lucide-react · Gemini API(회화·작문 채점·연상법) · ElevenLabs(음성)
