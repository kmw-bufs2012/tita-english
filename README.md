...
- **단어 학습 (일본어 1,600 + 영어 1500)** — Day당 20개 단위, 간격 반복(SR) 스케줄
  ...
  - **N1 tail 400** (7번): 저빈도 구간, 2회분(Day 1~10 + 11~20)으로 확장. Day 1~5·11~15는 **和語 동사·형용사·명사**(`捗る`·`滞る`·`拙い`·`覚束ない`·`憚る`·`揺さぶる`), Day 6~10·16~20은 **특수 요미**(`為替=かわせ`·`所以=ゆえん`·`五月雨=さみだれ`·`太刀=たち`)와 오독 유발 짝(`工夫` くふう/こうふ, `上手` うわて/じょうず, `決裁`/`決済`, `遍在`/`偏在`, `大勢` おおぜい/たいせい). 뜻 칸이 쉬워 보여도 **학습 목표는 요미**입니다
