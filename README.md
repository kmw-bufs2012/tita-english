...
- **작문 연습 (AI 채점)**: **문장 영작**(기초·중급·고급·실전 4단계) · **자유 작문** · **IT 비즈니스 실무 작문**을 티타가 채점해 줘요 — 모범답안·잘한 점·교정 팁·점수(0~100)를 한 번에. 합격(60점↑) 시 XP 적립. 각 모드별로 엄선된 화제 리스트(문장 영작 3,600개 · 자유 작문 1,600개 · IT 실무 1,000개, **총 6,200개**)를 제공해 누를 때마다 새 문제가 나와요
