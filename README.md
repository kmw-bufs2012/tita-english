...
- **영어 문법 (중학·고등·수능·대학원)**: 단계별 문법 단원(중학 22 · 고등 24 · 수능 어법 20 · **대학원 학술 영문법 20**, 총 86단원) 학습. 대학원 과정은 명사화·헤징·분열문·학술 시제 등 논문 영어 문법까지 다뤄요
...
- **작문 연습 (AI 채점)**: **문장 영작**(기초·중급·고급·실전 4단계)과 **자유 작문**을 티타가 채점해 줘요 — 모범답안·잘한 점·교정 팁·점수(0~100)를 한 번에. 합격(60점↑) 시 XP 적립. 조합형 생성기로 **문장 영작 약 19,800가지 · 자유 작문 약 15,600가지** 경우의 수를 제공해 매번 새로운 문제가 나와요
